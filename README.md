...
+ <img src="http://chart.googleapis.com/chart?cht=tx&chl= t ]in T" style="border:none;"> 代表整個訂貨計畫中的第 t 期；<img src="http://chart.googleapis.com/chart?cht=tx&chl= T = {1,...,6}" style="border:none;">
